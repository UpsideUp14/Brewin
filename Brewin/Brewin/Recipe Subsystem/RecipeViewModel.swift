...
class RecipeViewModel: ObservableObject {
    ...
    static func mockRecipeViewModel() -> RecipeViewModel {
        ...
        let chemexRecipeInstruction0 = Instruction(id: UUID(),
                                                   ...
                                                   time: chemexInstructionTime0)
        let chemexInstructionTime1: TimeInterval = 0
        let chemexRecipeInstruction1 = Instruction(id: UUID(),
                                                   message: "Put 15g of Coffee into filter",
                                                   time: chemexInstructionTime1)
        let chemexInstructionTime2: TimeInterval = 60
        let chemexRecipeInstruction2 = Instruction(id: UUID(),
                                                   message: "Pour 150ml of water into kettle",
                                                   time: chemexInstructionTime2)
        let v60InstructionTime: TimeInterval = 90
        let v60RecipeInstruction = Instruction(id: UUID(),
                                               message: "Put filter into V60",
                                               time: v60InstructionTime)
